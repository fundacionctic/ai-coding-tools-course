...
This Java framework, introduced in January 2026, ports Claude Code's Agent Skills to the Spring ecosystem, enabling model-agnostic deployment across OpenAI, Anthropic, Google Gemini, and other LLM providers without vendor lock-in (Spring AI Blog, January 13, 2026).
